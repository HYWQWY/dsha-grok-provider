...
* text-only result instead of failing the call). Resolves the session's latest routed provider/model and answers whether the exact route declares image input; any resolution failure means "no".
* @param resolveLlm - the LLM resolver.
